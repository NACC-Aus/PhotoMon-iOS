...
class PhotoAnnotationView: MKPinAnnotationView {
    @objc weak var imageData: UIImage?
    @objc weak var calloutView: PhotoCalloutView?
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        if selected {
            ...
            let calloutView = PhotoCalloutView(annotation: annotation as! MKShape, image: imageData)
