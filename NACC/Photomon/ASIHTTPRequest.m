...
- (void)updateUploadProgress
{
    ...
    float progressAmount = (float)((([self totalBytesSent]-[self uploadBufferSize])*1.0)/(([self postLength]-[self uploadBufferSize])*1.0));
    [uploadProgressDelegate performSelector:@selector(request:didProgress:) withObject:self withObject:[NSNumber numberWithFloat:progressAmount]];
